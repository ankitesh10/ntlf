...
import {FETCH_SESSIONS, SELECT_DAY, FETCH_VENUES_TYPES, SELECT_VENUE, SELECT_TYPE} from './types';
...
export const fetchVenuesAndTypes = () => async dispatch => {
    const response = await nasscom.get(`/site/sync?api_key=${KEY}&format=json&modify_date=0`);
